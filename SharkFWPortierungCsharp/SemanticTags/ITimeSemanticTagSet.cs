...
namespace Shark {
  namespace ASIP {
    ...
    public interface ITimeSemanticTagSet : ISemanticTagSet {
      ...
      new IList<ITimeSemanticTag> SemanticTags { get; }
      ...
      /// <param name="si">  The subject identifier. </param>
      /// <param name="time"> The time of timeSemanticTag. </param>
      ///
      ...
      ITimeSemanticTag createTimeSemanticTag(string name, string si, ITime time);
      ...
      /// <returns> The created semantic tag. </returns>
      /// <exception cref="SharkASIPException">Throws an Exception if an identical tag already exists.</exception>
      ITimeSemanticTag createTimeSemanticTag(string name, string[] sis, IList<ITime> times);
